...
urlpatterns = [
    ...
    path('remove-from-cart/<str:num>/',mainApp.removeFromCart),
    ...
    path('forget-password-1/',mainApp.forgetPassword1),
    path('forget-password-2/',mainApp.forgetPassword2),
    path('forget-password-3/',mainApp.forgetPassword3),
